...
export default {
  ...
  methods: {
    ...
    updateDialog(data) {
      ...
      this.addForm.teacherName = data.teacherInfo.teacherName
      this.addForm.createdAt = data.teacherInfo.createdAt
      this.addForm.address = data.teacherInfo.address
      this.addForm.idNumber = data.teacherInfo.idNumber
    },
    // 删除
    deleteAA(id) {
